...
INSERT INTO users (id, name, email, password, free, street, city, st, zip, photo, rate) VALUES (1, 'u1 Motif', 'u1@gmail.com', '111', 'Y', '150 Town Center Blvd', 'Garland', 'TX', '75040', '/u1.gif', 60);
INSERT INTO users (id, name, email, password, free, street, city, st, zip, photo, rate) VALUES (2, 'u2 Foreman', 'u2@gmail.com', '111', 'Y', '190 E. Stacy Rd', 'Allen', 'TX', '75002', '/u2.gif', 50);
INSERT INTO users (id, name, email, password, free, street, city, st, zip, photo, rate) VALUES (3, 'u3 Newsome', 'u3@gmail.com', '111', 'Y', '2740 N. Central Exwy.', 'Plano', 'TX', '75074', '/u3.gif', 30);
INSERT INTO users (id, name, email, password, free, street, city, st, zip, photo, rate) VALUES (4, 'u4 Carpenter', 'u4@gmail.com', '111', 'Y', '7909 Lyndon B Johnson', 'Dallas', 'TX', '75251', '/u4.gif', 50);
INSERT INTO users (id, name, email, password, free, street, city, st, zip, photo, rate) VALUES (5, 'u5 Rancher', 'u5@gmail.com', '111', 'N', '1106 E. I-30', 'Rockwall', 'TX', '75087', '/u5.gif', 0);
